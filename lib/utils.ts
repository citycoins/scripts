...
export const debugLog = (msg: string) => ENABLE_LOGS && console.log(`DEBUG: ${msg}`)
...
export function disclaimerIntro(title: string, description: string, requiresKey: boolean): void {
  printDivider()
  console.log(`${title.toUpperCase()}`)
  console.log(description)
  printDivider()
  requiresKey && console.log(
